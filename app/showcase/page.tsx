  ...
  return (
    <TooltipProvider>
      ...
      <main className="mx-auto max-w-6xl px-6 py-12">
        <Breadcrumbs
          items={[{ label: "Docs", href: "/" }, { label: "Design System" }]}
          className="mb-6"
        />
        ...
        <div className="mb-12 flex flex-col gap-3">
          ...
          <p className="max-w-xl text-muted-foreground">
            Neutral grayscale, one blue accent, documentation-first layout.
            Every primitive below is exported from{" "}
            <code className="font-mono text-xs">components/ui</code> and ready
            to compose.
          </p>
        </div>
          ...
          <div className="flex-1 space-y-16">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Conflict-free replicated data type for offline-first
                      editing.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Prompt history and architectural decisions, versioned per
                      feature.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
            ...
            <section className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <Avatar src="https://github.com/vercel.png" alt="" />
            ...
            <section id="data-flow" className="scroll-mt-20 space-y-4">
              ...
              <Tabs defaultValue="overview" className="max-w-md">
                ...
                <TabsContent value="overview">
                  A CRDT-backed sync layer for the editor, chosen for offline
                  resilience.
                </TabsContent>
                <TabsContent value="decisions">
                  Considered OT; chose CRDTs for simpler conflict resolution at
                  the edge.
                </TabsContent>
                <TabsContent value="prompts">
                  Prompt history is logged per commit and shown in the AI
                  Workflow tab.
                </TabsContent>
              </Tabs>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3">
                <Callout type="info" title="Why this matters">
                  This pattern trades a small memory overhead for guaranteed
                  convergence without a central server.
                </Callout>
                <Callout type="warning" title="Known limitation">
                  Tombstones accumulate over long sessions; a compaction pass
                  runs every 500 operations.
                </Callout>
                <Callout type="success" title="Result">
                  p95 sync latency dropped from 420ms to 60ms after switching
                  transports.
                </Callout>
              </div>
            </section>
